...
class GDImage {
    ...
    /**
     * Loads an image from GDImage or GDFigure class.
     * @package GDImage
     * @access public
     * @param GDImage $element GDImage or GDFigure class.
     * @return void
     */
    ...
    public function from($element = NULL) {
        if (!empty($element) && $element instanceof GDImage) {
        ...
        if (!empty($filename)) {
            ...
            if (filter_var($filename, FILTER_VALIDATE_URL)) {
                ...
                if (!empty($image)) {
                    ...
                    $this->_type = GDUtils::getImageType($filename);
                ...
                if (is_file($filename)) {
                    $this->_from = 'local';
                    $this->_type = $image_type = GDUtils::getImageType($filename);
                    $this->_extension = GDUtils::getExtension($filename);
    ...
    public function toJPG() {
        ...
        $this->_mimetype = GDUtils::getMimetypeByImageType(IMAGETYPE_JPEG);
    }
    ...
    public function toPNG() {
        ...
        $this->_mimetype = GDUtils::getMimetypeByImageType(IMAGETYPE_PNG);
    }
    ...
    public function toGIF() {
        ...
        $this->_mimetype = GDUtils::getMimetypeByImageType(IMAGETYPE_GIF);
    }
